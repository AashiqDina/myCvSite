...
async function init(meshes)
{
    ...
    // for(var i = 0; i <= mesh.vertices.length; i = i+2){
    //     mesh.vertices[i] += 0.13 * random(-1,1);
    // }

    // for(var i = 0; i <= mesh.vertexNormals.length; i = i+2){
    //     mesh.vertexNormals[i] += 0.14 * random(-1,1);
    // }
